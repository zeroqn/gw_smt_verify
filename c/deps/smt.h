...
#define __DEFINE_MOLECULE_API_DECORATOR_SMT
...
MOLECULE_API_DECORATOR  mol_errno       MolReader_KVPair_verify                         (const mol_seg_t*, bool);
#define                                 MolReader_KVPair_actual_field_count(s)          mol_table_actual_field_count(s)
#define                                 MolReader_KVPair_has_extra_fields(s)            mol_table_has_extra_fields(s, 2)
#define                                 MolReader_KVPair_get_k(s)                       mol_table_slice_by_index(s, 0)
#define                                 MolReader_KVPair_get_v(s)                       mol_table_slice_by_index(s, 1)
MOLECULE_API_DECORATOR  mol_errno       MolReader_KVPairVec_verify                      (const mol_seg_t*, bool);
#define                                 MolReader_KVPairVec_length(s)                   mol_dynvec_length(s)
#define                                 MolReader_KVPairVec_get(s, i)                   mol_dynvec_slice_by_index(s, i)
MOLECULE_API_DECORATOR  mol_errno       MolReader_SMTCase_verify                        (const mol_seg_t*, bool);
#define                                 MolReader_SMTCase_actual_field_count(s)         mol_table_actual_field_count(s)
#define                                 MolReader_SMTCase_has_extra_fields(s)           mol_table_has_extra_fields(s, 3)
#define                                 MolReader_SMTCase_get_proof(s)                  mol_table_slice_by_index(s, 0)
#define                                 MolReader_SMTCase_get_kv_state(s)               mol_table_slice_by_index(s, 1)
#define                                 MolReader_SMTCase_get_root(s)                   mol_table_slice_by_index(s, 2)
...
#define                                 MolBuilder_KVPair_init(b)                       mol_table_builder_initialize(b, 512, 2)
#define                                 MolBuilder_KVPair_set_k(b, p, l)                mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_KVPair_set_v(b, p, l)                mol_table_builder_add(b, 1, p, l)
MOLECULE_API_DECORATOR  mol_seg_res_t   MolBuilder_KVPair_build                         (mol_builder_t);
#define                                 MolBuilder_KVPair_clear(b)                      mol_builder_discard(b)
#define                                 MolBuilder_KVPairVec_init(b)                    mol_builder_initialize_with_capacity(b, 2048, 64)
#define                                 MolBuilder_KVPairVec_push(b, p, l)              mol_dynvec_builder_push(b, p, l)
#define                                 MolBuilder_KVPairVec_build(b)                   mol_dynvec_builder_finalize(b)
#define                                 MolBuilder_KVPairVec_clear(b)                   mol_builder_discard(b)
#define                                 MolBuilder_SMTCase_init(b)                      mol_table_builder_initialize(b, 256, 3)
#define                                 MolBuilder_SMTCase_set_proof(b, p, l)           mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_SMTCase_set_kv_state(b, p, l)        mol_table_builder_add(b, 1, p, l)
#define                                 MolBuilder_SMTCase_set_root(b, p, l)            mol_table_builder_add(b, 2, p, l)
MOLECULE_API_DECORATOR  mol_seg_res_t   MolBuilder_SMTCase_build                        (mol_builder_t);
#define                                 MolBuilder_SMTCase_clear(b)                     mol_builder_discard(b)
...
MOLECULE_API_DECORATOR const uint8_t MolDefault_KVPair[76]       =  {
    0x4c, ____, ____, ____, 0x0c, ____, ____, ____, 0x2c, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
...
MOLECULE_API_DECORATOR const uint8_t MolDefault_KVPairVec[4]     =  {0x04, ____, ____, ____};
MOLECULE_API_DECORATOR const uint8_t MolDefault_SMTCase[56]      =  {
    0x38, ____, ____, ____, 0x10, ____, ____, ____, 0x14, ____, ____, ____,
    0x18, ____, ____, ____, ____, ____, ____, ____, 0x04, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,
};
...
MOLECULE_API_DECORATOR mol_errno MolReader_KVPair_verify (const mol_seg_t *input, bool compatible) {
...
MOLECULE_API_DECORATOR mol_errno MolReader_KVPairVec_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
    ...
    for (mol_num_t i=1; i<item_count; i++) {
        ...
        mol_errno errno = MolReader_KVPair_verify(&inner, compatible);
        if (errno != MOL_OK) {
            return MOL_ERR_DATA;
        }
        offset = end;
    ...
    return MolReader_KVPair_verify(&inner, compatible);
}
MOLECULE_API_DECORATOR mol_errno MolReader_SMTCase_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
...
MOLECULE_API_DECORATOR mol_seg_res_t MolBuilder_KVPair_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 12;
    mol_num_t len;
...
MOLECULE_API_DECORATOR mol_seg_res_t MolBuilder_SMTCase_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 16;
    mol_num_t len;
...
#ifdef __DEFINE_MOLECULE_API_DECORATOR_SMT
#undef MOLECULE_API_DECORATOR
#undef __DEFINE_MOLECULE_API_DECORATOR_SMT
#endif /* __DEFINE_MOLECULE_API_DECORATOR_SMT */
